  ...
  return (
    <div className="bg-gray-900 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-8 pt-8 pb-4">
        <div>
          <h1 className="text-3xl font-bold mb-1 text-white">Welcome, {profileForm.full_name || 'Student'}</h1>
          <p className="text-gray-400">Your personal dashboard overview</p>
        </div>
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <input className="bg-gray-800 text-white rounded-full px-4 py-2 shadow focus:outline-none" placeholder="Search" />
          <div className="bg-gray-800 rounded-full p-2 shadow">
      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto pb-8">
        ...
        <div className="flex-1 space-y-8">
          {/* Profile Card */}
          <div className="bg-gray-800 rounded-2xl shadow-lg p-6 flex items-center gap-6 text-gray-100">
            <img src={profile?.avatar_url || '/default-avatar.png'} alt="Avatar" className="w-24 h-24 rounded-full object-cover border-4 border-gray-900 shadow" />
            <div>
              <h2 className="text-2xl font-bold mb-1">{profileForm.full_name}</h2>
              <p className="text-gray-400 font-medium mb-2">Student</p>
          ...
          {editMode && (
            <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
              <div className="bg-gray-900 p-8 rounded-2xl shadow-xl w-full max-w-md text-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl p-6 shadow-lg bg-gradient-to-tr from-pink-900 via-orange-900 to-purple-900 text-gray-100">
              ...
              <p className="text-gray-400">Avg. Completed</p>
            </div>
            <div className="rounded-2xl p-6 shadow-lg bg-gradient-to-tr from-blue-900 via-cyan-900 to-purple-900 text-gray-100">
              <div className="flex justify-between items-center mb-2">
              ...
              <p className="text-gray-400">Classes Enrolled</p>
            </div>
          </div>
          {/* Chart Area (Placeholder) */}
          <div className="bg-gray-800 rounded-2xl shadow-lg p-6 text-gray-100">
            <h3 className="font-bold text-lg mb-2">Focusing</h3>
            <p className="text-gray-400 mb-2">Productivity analytics</p>
            <div className="h-32 flex items-center justify-center text-gray-500">[Chart Placeholder]</div>
            <div className="flex justify-between mt-4">
              <span className="font-semibold">41%</span>
              <span className="text-gray-400">Avg. Concentration</span>
            </div>
          </div>
        </div>
        {/* Sidebar */}
        <div className="w-full md:w-80 flex-shrink-0 space-y-8">
              ...
              <ul className="space-y-4">
                {scheduledClasses.map(cls => (
                  <li key={cls.id} className="flex flex-col gap-1">
                    ...
                    <span className="text-gray-400">{new Date(cls.start_time).toLocaleString()}</span>
                    <span className="text-gray-400">Duration: {cls.duration || 'N/A'} mins</span>
                  </li>
                ))}
              </ul>
            )}
          ...
          <div className="bg-gray-800 rounded-2xl shadow-lg p-6 text-gray-100">
            ...
            <p className="text-gray-400 mb-2">Most common areas of interests</p>
              ...
              {skillProgress.map(skill => (
                <div key={skill.skill}>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-3">
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 h-3 rounded-full" style={{ width: `${skill.percent}%` }}></div>
                  </div>
                </div>
              ))}
            </div>
